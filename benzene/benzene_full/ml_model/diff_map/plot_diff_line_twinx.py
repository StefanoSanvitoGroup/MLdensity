...
ax.set_ylim([-2.5,3.0])
ax.set_yticks([-2.0,-1.0,0.0,1.0,2.0,3.0])
ax.set_yticklabels([r'$-2.0$',r'$-1.0$',0.0,1.0,2.0,3.0])
...
fig.savefig('figures/'+f'line_diff_al_{frame}_y{y_plane}.png',dpi=600,bbox_inches='tight')
plt.show()