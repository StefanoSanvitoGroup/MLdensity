...
fig.tight_layout()
fig.savefig('figures/'+f'dft_chg_al_{frame}_{temp}K_z{zplane:.2f}.png',dpi=300,bbox_inches='tight')
plt.show()
...
fig.tight_layout()
fig.savefig('figures/'+f'ml_chg_al_{frame}_{temp}K_z{zplane:.2f}.png',dpi=300,bbox_inches='tight')
plt.show()
...
fig.tight_layout()
fig.savefig('figures/'+f'diff_chg_al_{frame}_{temp}K_z{zplane:.2f}.png',dpi=300,bbox_inches='tight')
plt.show()
...
plot_corr_scatter(r'CHG (e/$\rm \AA^3$)',chg_dft_points,chg_pred_points,savefig=True,model_name=f'test_{frame}_{temp}K_z{zplane:.2f}',show=True)