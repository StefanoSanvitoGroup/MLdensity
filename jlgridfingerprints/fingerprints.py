    ...
    def _initialize_distances(self, system):
        ...
        for elem in self.species:
            ...
            if len(elem_system) > 0:
                ...
                nn_elem_list.append(np.empty(0))
                nn_elem_dist.append(np.empty(0))
                nn_elem_vec.append(np.empty(0))
                nn_elem_start.append(np.empty(0))
                nn_elem_end.append(np.empty(0))
                nn_elem_num.append(np.zeros(self.centers.shape[0], dtype=np.int32))
